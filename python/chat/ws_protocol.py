...
from chat.protocol import UUID4, CanonicalUUID, UTCDateTime, invalid_json_constant, unique_json_object
...
def parse_frame(text: str, settings: Settings) -> MessageControl | MessageSend:
    ...
    try:
        ...
        code = "UNKNOWN_FIELD" if any(e["type"] == "extra_forbidden" for e in error.errors()) else "VALIDATION_ERROR"
